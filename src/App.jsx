...
export default function App() {
  ...
  function handleMouseMove(event) {
    setFocusedShape(() => {
      if (event.target !== event.target.getStage()) {
        ...
        // console.log(event.target.getParent().id());
        return event.target;
      }
      return null;
    });
  ...
  //     const currentDrawings = [ ...history[drawingsIdx] ];

  //     return [ ...historyTillPresent, currentDrawings ];
  //   });
   ...
   */
  // console.log('history', drawingHistory);
  // console.log('index', drawingsIdx);
  ...
  const drawings = [ ...snapshots[currIdx], ...activeCoords, animationShape ].filter(x => x !== null).map(
    (recipe) => {
      ...
      // const isFocused = focusedShape?.getParent().id() === id;
      switch(name) {
        case 'point': {
          return (
            <Point
...
//           console.log('index', drawingsIdx);
//           const historyTillPresent = history.slice(0, drawingsIdx + 1);
//           console.log('till present', historyTillPresent)
//           const currentDrawings = [ ...history[drawingsIdx] ];
//           console.log('current', currentDrawings)
//           const filteredDrawings = currentDrawings.filter(recipe => recipe.id !== idToDelete);
//           console.log('filtered', filteredDrawings)

//           return [ ...historyTillPresent, filteredDrawings ];
//         });
//       }
//     };
...
//   //     console.log(history);
//   //     const historyTillPresent = history.slice(0, drawingsIdx + 1);
//   //     console.log(historyTillPresent);
//   //     const currentDrawings = [ ...history[drawingsIdx] ];
